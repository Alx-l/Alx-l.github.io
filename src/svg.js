...
export const Add = (color) => {
  return h('svg',
    { style: { display: 'block' }, fill: color, viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
...
export const BackEnd = (color) => {
  return h('svg',
    { style: { display: 'block' }, fill: color, viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
    h('path', { d: 'M0 0h24v24H0z', fill: 'none' }),
    h('path', { d: 'M20 13H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1v-6c0-.55-.45-1-1-1zM7 19c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM20 3H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1zM7 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z' })
  )
}
/* –––––––––––––––––––––––––––––––––––––––––––––––––– */
...
export const FrontEnd = (color) => {
  return h('svg',
    { style: { display: 'block' }, fill: color, viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
    h('path', { d: 'M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-5 14H4v-4h11v4zm0-5H4V9h11v4zm5 5h-4V9h4v9z' }),
    h('path', { d: 'M0 0h24v24H0z', fill: 'none' })
  )
}
/* –––––––––––––––––––––––––––––––––––––––––––––––––– */
...
export const HappySmiley = (color) => {
  return h('svg',
    { style: { display: 'block' }, fill: color, viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
    h('path', { d: 'M11.99 2C6.47 2 2 6.47 2 12s4.47 10 9.99 10S22 17.53 22 12 17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm1-10.06L14.06 11l1.06-1.06L16.18 11l1.06-1.06-2.12-2.12zm-4.12 0L9.94 11 11 9.94 8.88 7.82 6.76 9.94 7.82 11zM12 17.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5z' }),
    h('path', { d: 'M0 0h24v24H0z', fill: 'none' })
  )
}
/* –––––––––––––––––––––––––––––––––––––––––––––––––– */
...
export const Laptop = (color) => {
  return h('svg',
    { style: { display: 'block' }, fill: color, viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
    h('path', { d: 'M0 0h24v24H0z', fill: 'none' }),
    h('path', { d: 'M20 18c1.1 0 1.99-.9 1.99-2L22 5c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2H0c0 1.1.9 2 2 2h20c1.1 0 2-.9 2-2h-4zM4 5h16v11H4V5zm8 14c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z' })
  )
}
/* –––––––––––––––––––––––––––––––––––––––––––––––––– */
...
export const Movie = (color) => {
  return h('svg',
    { style: { display: 'block' }, fill: color, viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
    h('path', { d: 'M18 3v2h-2V3H8v2H6V3H4v18h2v-2h2v2h8v-2h2v2h2V3h-2zM8 17H6v-2h2v2zm0-4H6v-2h2v2zm0-4H6V7h2v2zm10 8h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2V7h2v2z' }),
    h('path', { d: 'M0 0h24v24H0z', fill: 'none' })
  )
}
/* –––––––––––––––––––––––––––––––––––––––––––––––––– */
...
export const PersonPin = (color) => {
  return h('svg',
    { style: { display: 'block' }, fill: color, viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
    h('path', { d: 'M19 2H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h4l3 3 3-3h4c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-7 3.3c1.49 0 2.7 1.21 2.7 2.7 0 1.49-1.21 2.7-2.7 2.7-1.49 0-2.7-1.21-2.7-2.7 0-1.49 1.21-2.7 2.7-2.7zM18 16H6v-.9c0-2 4-3.1 6-3.1s6 1.1 6 3.1v.9z' }),
    h('path', { d: 'M0 0h24v24H0z', fill: 'none' })
  )
}
/* –––––––––––––––––––––––––––––––––––––––––––––––––– */
...
export const ThumbUp = (color) => {
  return h('svg',
    { style: { display: 'block' }, fill: color, viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
    h('path', { d: 'M0 0h24v24H0z', fill: 'none' }),
    h('path', { d: 'M1 21h4V9H1v12zm22-11c0-1.1-.9-2-2-2h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 1 7.59 7.59C7.22 7.95 7 8.45 7 9v10c0 1.1.9 2 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73v-1.91l-.01-.01L23 10z' })
  )
}
/* –––––––––––––––––––––––––––––––––––––––––––––––––– */
...
export const TV = (color) => {
  return h('svg',
    { style: { display: 'block' }, fill: color, viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
    h('path', { d: 'M0 0h24v24H0z', fill: 'none' }),
    h('path', { d: 'M21 3H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h5v2h8v-2h5c1.1 0 1.99-.9 1.99-2L23 5c0-1.1-.9-2-2-2zm0 14H3V5h18v12z' })
  )
}
/* –––––––––––––––––––––––––––––––––––––––––––––––––– */
