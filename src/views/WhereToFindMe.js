...
const WhereToFindMe = () => {
  return (
    h('div', { className: 'v-wheretofindme' },
      ...
      h('div', { className: 'l-textBlock--sm' },
        ...
        h('p', {}, 'But since that could take a while before you randomly bump into me, feel free to send me an email :',
          h('br'),
        ...
        h('p', {}, 'My ',
          h('a', { href: 'https://gist.github.com/Alx-l', target: '_blank' },
            h('span', { className: 'u-highlight u-linkSweep' }, 'Gists '),
            'maybe?'
          )
        )
      )
